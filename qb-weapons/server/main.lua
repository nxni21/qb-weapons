...
-- AMMO
QBCore.Functions.CreateUseableItem('pdpistol_ammo', function(source, item)
    TriggerClientEvent('weapons:client:AddAmmo', source, 'PDAMMO_PISTOL', 24, item)
end)

QBCore.Functions.CreateUseableItem('pdrifle_ammo', function(source, item)
    TriggerClientEvent('weapons:client:AddAmmo', source, 'PDAMMO_RIFLE', 60, item)
end)

QBCore.Functions.CreateUseableItem('pdsmg_ammo', function(source, item)
    TriggerClientEvent('weapons:client:AddAmmo', source, 'PDAMMO_SMG', 40, item)
end)

QBCore.Functions.CreateUseableItem('pdshotgun_ammo', function(source, item)
    TriggerClientEvent('weapons:client:AddAmmo', source, 'PDAMMO_SHOTGUN', 20, item)
end)
QBCore.Functions.CreateUseableItem('pdsnp_ammo', function(source, item)
    TriggerClientEvent('weapons:client:AddAmmo', source, 'PDAMMO_SNIPER', 20, item)
end)

QBCore.Functions.CreateUseableItem('pistol_ammo', function(source, item)
    TriggerClientEvent('weapons:client:AddAmmo', source, 'AMMO_PISTOL', 24, item)
end)

QBCore.Functions.CreateUseableItem('rifle_ammo', function(source, item)
    TriggerClientEvent('weapons:client:AddAmmo', source, 'AMMO_RIFLE', 60, item)
end)
...
QBCore.Functions.CreateUseableItem('shotgun_ammo', function(source, item)
    TriggerClientEvent('weapons:client:AddAmmo', source, 'AMMO_SHOTGUN', 20, item)
end)

QBCore.Functions.CreateUseableItem('mg_ammo', function(source, item)
    TriggerClientEvent('weapons:client:AddAmmo', source, 'AMMO_MG', 60, item)
end)

QBCore.Functions.CreateUseableItem('snp_ammo', function(source, item)
    TriggerClientEvent('weapons:client:AddAmmo', source, 'AMMO_SNIPER', 20, item)
end)

QBCore.Functions.CreateUseableItem('emp_ammo', function(source, item)
    TriggerClientEvent('weapons:client:AddAmmo', source, 'AMMO_EMPLAUNCHER', 20, item)
end)
